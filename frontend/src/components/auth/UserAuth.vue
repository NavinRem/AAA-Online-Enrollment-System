...
<template>
  <div class="flex min-h-screen w-full">
    ...
    <div class="flex-1 bg-white flex items-center justify-center p-12 lg:p-16">
      <div
        class="w-full max-w-[440px] bg-white p-12 px-8 border border-black/5 rounded-std shadow-2xl text-center"
      >
        <div class="mb-11">
          <img
        ...
        <div v-if="!isResetMode" class="relative flex items-center gap-4 my-10">
          ...
          <span
            class="text-2xs font-[900] text-content-muted uppercase tracking-[3px] whitespace-nowrap"
          >
            SECURE ACCESS
          </span>
          <div class="h-px flex-grow bg-content-muted/20"></div>
