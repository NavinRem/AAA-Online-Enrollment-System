<template>
  ...
  >
    <div
      v-if="show"
      class="fixed inset-0 w-screen h-screen bg-[#0a1e32]/50 backdrop-blur-md flex items-center justify-center z-[2000] p-4 sm:p-md"
    ...
    >
      ...
      >
        ...
        >
          ...
          <!-- Content Area -->
          <div
            class="p-md sm:p-xl max-h-[85vh] sm:max-h-[80vh] overflow-y-auto bg-white scrollable-v"
          >
            <slot></slot>
          </div>
