        ...
        <div v-if="isInactive" class="mb-lg">
          <div class="p-md bg-warning/10 border-l-4 border-warning rounded-sm flex flex-col gap-1">
            ...
            <span class="text-xs text-content-muted"
              >This parent account is currently disabled. Access to registration and profile updates
          ...
          <div v-if="activeTab === 'children'">
            ...
            <div class="flex flex-wrap gap-sm mb-xl" v-if="students.length > 0">
              <button
                v-for="s in students"
                :key="s.id || s.uid"
                class="flex items-center gap-sm px-md py-sm rounded-std border transition-all duration-200"
                :class="
                  selectedChildUid === (s.id || s.uid)
              ...
              >
                <div
                  class="w-8 h-8 rounded-full overflow-hidden border border-outline-std bg-surface-light"
                >
                  <img
                    :src="s.profileURL"
            ...
            <table class="ui-premium-table">
              ...
              <tbody>
                ...
                <tr v-for="(reg, idx) in filteredHistory" :key="reg.id">
                  ...
                  <td class="font-bold text-content-dark">{{ reg.programTitle }}</td>
                  <td class="text-xs font-bold text-primary italic">{{ reg.studentName }}</td>
                  <td class="text-center text-xs font-bold text-content-muted">
      ...
      <template #right-content v-if="parent">
        ...
        <div class="ui-detail-card flex flex-col items-center text-center p-0 overflow-hidden">
          ...
          <div class="relative -mt-16 mb-md">
            <div
              class="w-32 h-32 rounded-full border-4 border-white shadow-xl bg-white overflow-hidden group"
            >
              <img
          ...
          <div class="px-xl pb-xl flex flex-col items-center w-full">
            ...
            <div class="ui-data-list w-full grid-cols-1 gap-y-lg">
              ...
              <div class="ui-data-item">
                ...
                <span
                  class="ui-data-value text-left text-xs text-primary font-black lowercase truncate block w-full"
                  >{{ parent?.email }}</span
                >
              </div>
            </div>
        ...
        <div class="ui-detail-card mt-lg">
          ...
          <div class="flex flex-col gap-sm">
            ...
            >
              ...
              <div class="flex flex-col">
                <span
                  class="font-bold text-content-dark group-hover:text-primary transition-colors text-sm"
                  >{{ s.name }}</span
                >
                <span class="text-3xs text-content-muted uppercase font-black tracking-widest"
                  >Child Account</span
                >
              </div>
            </div>
